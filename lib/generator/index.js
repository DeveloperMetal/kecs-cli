...
function default_1(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const nodeModulesPath = findup_sync_1.default("node_modules");
        let outputPath = "";
        if (nodeModulesPath) {
            outputPath = path_1.default.resolve(path_1.default.join(nodeModulesPath, "@kryptonstudio/.ecs-client"));
        ...
        if (src && outputPath) {
            ...
            yield promises_1.default.writeFile(path_1.default.join(outputPath, 'package.json'), packageJson_1.generate(), { encoding: "utf-8" });
            installPackages([]);
